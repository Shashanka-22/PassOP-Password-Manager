...
const maneger = () => {
    ...
    const editPassword = (id) => {
        console.log('edting password with id',id)
            ...
            <div className=" p-3 md:mycontainer min-h-[83.5vh]">
                ...
                <div className='flex text-black flex-col p-4 gap-8 items-center'>
                    ...
                    <div className="flex flex-col md:flex-row w-full justify-between gap-8">
                        <input value={form.username} onChange={handleChange} placeholder='Enter your username' className='rounded-full border border-green-400 w-full p-4 py-1' type="text" name="username" id="username" />
                    ...
                    <button onClick={savePassword} className='flex justify-center items-center gap-4 bg-green-400 rounded-full px-8 py-2 w-fit hover:bg-green-300 border border-green-900'>
                        <lord-icon
                ...
                <div className="passwords">
                    <h1 className='font-bold text-2xl py-2'>Your Password</h1>
